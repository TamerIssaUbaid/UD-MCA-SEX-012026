...
let produtos = [
    ...
    { nome: 'Headset', preco: 200, estoque: 25 },
    { nome: 'Impressora', preco: 700, estoque: 8 },
    { nome: 'Webcam', preco: 150, estoque: 40 },
    { nome: 'SSD', preco: 400, estoque: 20 },
    { nome: 'HD Externo', preco: 350, estoque: 18 },
    { nome: 'Tablet', preco: 1500, estoque: 12 }
];
